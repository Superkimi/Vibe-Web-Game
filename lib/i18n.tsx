...
const zhMessages: Record<string, string> = {
  ...
  "Chinese": "中文",
  "3D Studio": "3D 工作室",
  "PlayCanvas 3D Studio": "PlayCanvas 3D 工作室",
  "PlayCanvas unavailable": "PlayCanvas 暂不可用",
  "3D Project": "3D 项目",
  "3D Schema-safe edit": "3D Schema 安全编辑",
  "Add spin": "添加旋转",
  "Add bob": "添加上下浮动",
  "Change primitive": "修改几何体",
  "Change metallic": "修改金属度",
  "Change roughness": "修改粗糙度",
  "Change intensity": "修改光照强度",
  "Change light range": "修改光照范围",
  "Change light type": "修改灯光类型",
  "Change camera FOV": "修改相机视场角",
  "Change camera clip": "修改相机裁剪面",
  "Change parent": "修改父级",
  "Change grid size": "修改网格尺寸",
  ...
  spin: "旋转",
  bob: "浮动",
  "Add a glowing sphere beside the portal ring.": "在传送门环旁边添加一个发光球体。",
  "Make the hero crystal spin slower and use a warmer material.": "让主水晶旋转慢一些，并使用更暖的材质。",
  "Duplicate the orbit cube and place it on the left side.": "复制轨道立方体并放到左侧。",
  "Describe a 3D change. I will propose validated PlayCanvas operations, show the diff, and wait for approval before touching the scene.": "描述一个 3D 改动。我会提出经过校验的 PlayCanvas 操作，展示差异，等待你批准后再修改场景。",
  "Describe the 3D change you want…": "描述你想要的 3D 改动……",
  "Play mode · spin and bob behaviors are live": "运行模式 · 旋转和浮动行为已生效",
  "Select an entity in the scene tree, then edit transforms and components in Inspector": "在场景树选择对象，然后在检查器中编辑变换和组件",
};
